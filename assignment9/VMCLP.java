...
public class VMCLP {
    ...
    private static void help() {
        ...
        System.out.println("stop - stop the vending machine");
        System.out.println("showItems - show items");
        System.out.println("showCoins - show coins");
        System.out.println("insert [10|50|100] - insert coins");
        System.out.println("select [milk|juice|coffee] - select items");
    }
    ...
    public static void main(String[] args) throws IOException {
        ...
        while((line = br.readLine()) != null) {
            ...
            if (line.equals("")) {
                ...
                String[] la = line.split("[ \t]", 2);
                if (la.length < 2) {
                    assert false: "In select command: " + line;
                } else {
                    String a = la[1].trim();
                    if (a.equals("milk")) {
